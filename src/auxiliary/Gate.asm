...
Syscall_NtFreeVirtualMemory:
    push r10        ; Hoppa till syscall-instruktionen
    xor rax, rax
    mov r10, rcx    ; Flytta första argumentet (ProcessHandle) till R10 (enligt x64 konvention)
    mov eax, r11d   ; Ladda SSN
    ret
